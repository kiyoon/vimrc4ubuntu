...
--    file_ignore_patterns = { ".git/", "node_modules" },
    ...
    mappings = {
	  n = {
	  	...
	  	["PO"] = path_actions.insert_abspath_O_insert,
	  	["<space>pi"] = path_actions.insert_relpath_i_visual,
	  	["<space>pI"] = path_actions.insert_relpath_I_visual,
	  	["<space>pa"] = path_actions.insert_relpath_a_visual,
	  	["<space>pA"] = path_actions.insert_relpath_A_visual,
	  	["<space>po"] = path_actions.insert_relpath_o_visual,
	  	["<space>pO"] = path_actions.insert_relpath_O_visual,
	  	["<space>Pi"] = path_actions.insert_abspath_i_visual,
	  	["<space>PI"] = path_actions.insert_abspath_I_visual,
	  	["<space>Pa"] = path_actions.insert_abspath_a_visual,
	  	["<space>PA"] = path_actions.insert_abspath_A_visual,
	  	["<space>Po"] = path_actions.insert_abspath_o_visual,
	  	["<space>PO"] = path_actions.insert_abspath_O_visual,
